...
public class TestPopulation {
    ...
    public static PopulationBuilder instantUsers =
        TestScenario.defaultLoadTest
                .injectOpen(
                        nothingFor(5), //nothing to do for 5 second
                        atOnceUsers(USER_COUNT)); //set 5 users by default

    public static PopulationBuilder rampUsers =
            TestScenario.defaultLoadTest
                    .injectOpen(
                            nothingFor(5), //nothing to do for 5 second
                            CoreDsl.rampUsers(USER_COUNT).during(RAMP_DURATION)); //set 5 users by default for 10 second by default
